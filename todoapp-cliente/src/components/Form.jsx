...
export default function Form() {
  ...
  return (
    <div className="shadow-[0_40px_80px_rgba(0,0,0,0.2),0_60px_80px_rgba(0,0,0,0.4)] w-full">
      <img
        src="./images/bg-desktop-dark.jpg"
        alt="banner"
        className="hidden md:block absolute top-0 left-1/2 -translate-x-1/2 h-[350px] w-auto min-w-[100vw] object-cover"
      />
      <img
      ...
      >
        <div className="flex flex-col gap-5">
          <div className="flex gap-3 p-3 items-center tex-[#777a92ff] bg-[#25273cff] rounded-md">
            <button
              type="button"
              ...
              className={`h-5 w-5 rounded-full flex items-center justify-center ${
                crearCompletada
                  ...
                  : "border border-[#494C6B] hover:border-[#3a7bfdff]"
              }`}
            >
              {crearCompletada && (
            ...
            <input
              ...
              className="flex-1 p-2 josefin text-[18px] text-[#e4e5f1ff] outline-none focus:outline-none focus:ring-0 rounded placeholder:text-[#777a92ff] josefintext-[18px] caret-[#3a7bfdff]"
            />
            <button
              type="submit"
              className=" p-2 text-[#9394a5ff] hover:text-[#3a7bfdff] rounded-full hover:border hover:border-[#3a7bfdff]"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="11" height="9">
                <path
                  fill="none"
          ...
          <ul className="bg-[#25273cff] divide-y-[0.5px] divide-[#393a4cff] text-[18px]  rounded-md">
            {tareasFiltradas.map((tarea) => (
              <li key={tarea.id} className="p-5 flex items-center group ">
                  ...
                  {tarea.completada ? (
                    <div className=" flex justify-center items-center text-center bg-gradient-to-br from-[#57ddffff] to-[#c058f3ff] h-5 w-5 rounded-full">
                      <button
                        ...
                        className="bg-gradient-to-br from-[#57ddffff] to-[#c058f3ff] rounded-full h-[18px] w-[18px] flex justify-center items-center"
                      >
                        <svg
                ...
                <span
                  className={
                    tarea.completada
                      ? "line-through text-[#4d5066ff] h-6 josefin justify-center px-5 w-full"
                ...
                <button
                  ...
                  className="md:opacity-0 md:group-hover:opacity-100 md:transition-opacity md:duration-200"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
            ...
            <div className="bg-[#25273cff] p-4 flex justify-between items-center text-[#777a92ff] text-[14px] josefin rounded-b-md">
              <span>
                {tareasPendientes}{" "}
          ...
          <div className="w-full p-1 bg-[#25273cff] text-[#777a92ff] text-[14px] rounded-md md:hidden justify-center items-center text-center">
            <button
              onClick={() => setFiltro("todas")}
              className={`p-2 rounded josefin ${
                filtro === "todas" ? "text-blue-400" : "hover:text-[#e4e5f1ff]"
              }`}
            >
              All
            </button>
